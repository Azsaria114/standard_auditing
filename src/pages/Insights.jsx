            ...
            {blogArticles.map((article, index) => (
              <article key={index} className="insights-blog__card">
                ...
                <div className="insights-blog__content">
                  ...
                  {String(article.link || '').startsWith('/insights/') ? (
