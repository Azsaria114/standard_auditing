...
import corporateTaxImage from '../assets/Services-CorporateTaxPage.webp'
          ...
          <div className="service-hero__grid service-hero__grid--auditing">
            ...
            <div className="service-hero__image-column">
              <div className="service-hero__image-wrapper">
                <img 
                  src={corporateTaxImage} 
                  alt="Corporate Tax Service" 
            ...
            <div className="service-hero__content-column">
              <span className="service-hero__label">Corporate Tax</span>

              <p className="service-hero__description service-hero__description--auditing body-opensans">
                Corporate tax affects profit directly. Errors create permanent costs. Our approach focuses on correct application from day one. 
                We apply UAE Corporate Tax rules as they evolve. Our 25+ years of tax advisory experience informs every calculation and adjustment.
              </p>
      ...
      <section className="service-comparison service-comparison--pricing-bg" data-animate="slide-up" data-animate-delay="0.1">
        <div className="service-comparison__container">
          <div className="service-comparison__header">
            ...
            <h2 className="service-comparison__main-title h1-montserrat">Reduce Exposure & Control Tax Impact</h2>
          </div>
          ...
          <div className="comparison-container">
            ...
            <div className="comparison-left">
              <div className="comparison-left__content">
                <h2 className="comparison-title">As decision makers, you care about:</h2>
                ...
                <ul className="comparison-list muted">
                  <li>
                    ...
                    <span className="comparison-item-title">Paying only what is legally required</span>
                  </li>
                  ...
                  <li>
                    ...
                    <span className="comparison-item-title">Avoiding aggressive positions that trigger audits</span>
                  </li>
                  ...
                  <li>
                    ...
                    <span className="comparison-item-title">Maintaining clean documentation</span>
                  </li>
                </ul>
              </div>
              ...
              <div className="comparison-right-card">
                <h2 className="comparison-title">How we reduce tax burden legally:</h2>
                ...
                <ul className="comparison-list emphasized">
                  <li>
                    ...
                    <span className="comparison-item-title">Correct classification of income streams</span>
                  </li>
                  ...
                  <li>
                    ...
                    <span className="comparison-item-title">Identification of allowable deductions</span>
                  </li>
                  ...
                  <li>
                    ...
                    <span className="comparison-item-title">Proper treatment of expenses and provisions</span>
                  </li>
                  ...
                  <li>
                    ...
                    <span className="comparison-item-title">Structuring within current law</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <p className="comparison-footer-text">
              Industry knowledge matters. Different sectors face different tax risks. We structure income correctly based on real operations, not templates. 
              Our work ensures businesses remain compliant and audit-ready. Leadership understands the tax position clearly before filing, not after.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="pricing" className="pricing-section pricing-section--auditing" data-animate="fade-in" data-animate-delay="0.2">
        <div className="pricing-section__container">
          <div className="pricing-section__auditing-header">
            ...
            <h2 className="pricing-section__auditing-title h1-montserrat">Corporate Tax Pricing for SMEs</h2>
          </div>

          <div className="pricing-section__grid">
            <div className="pricing-section__card">
              <h3 className="pricing-section__card-title h3-montserrat">Corporate Tax (Filing Only)</h3>
              ...
              <p className="pricing-section__card-description body-opensans">
                Ideal for businesses under AED 3 million annual revenue, qualifying for Small Business Relief.
              </p>
            ...
            <div className="pricing-section__card">
              <h3 className="pricing-section__card-title h3-montserrat">Corporate Tax (Filing + Tax Payable)</h3>
              ...
              <p className="pricing-section__card-description body-opensans">
                Suitable for companies obligated to compute and pay Corporate Tax under current FTA rules, typically those with revenues above AED 3 million.
              </p>
