            ...
            <form className="contact-form" onSubmit={handleSubmit}>
              ...
              <div className="contact-form__checkbox">
                ...
                <label htmlFor="consent" className="contact-form__checkbox-label small-body-opensans">
                  By submitting my personal data, I consent to Standard Auditing, LLC storing and processing my information in accordance with the Standard Auditing, LLC Privacy Policy.
                </label>
              </div>
