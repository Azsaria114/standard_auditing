        ...
        <div className="service-hero__container service-hero__container--auditing">
          <div className="service-hero__grid service-hero__grid--auditing">
            ...
            <div className="service-hero__content-column">
              <span className="service-hero__label">Accounting & Bookkeeping</span>
              ...
              <p className="service-hero__description service-hero__description--auditing body-opensans">
                ...
                We have refined our accounting and bookkeeping processes over decades. Our experience across sectors reduces rework, corrections, and reporting delays.
              </p>
      ...
      <section className="service-comparison service-comparison--pricing-bg">
        <div className="service-comparison__container">
          <div className="service-comparison__header">
            ...
            <h2 className="service-comparison__main-title h1-montserrat">See Your True Financial Position Anytime</h2>
          </div>
          ...
          <div className="comparison-container">
            ...
            <div className="comparison-left">
              <div className="comparison-left__content">
                <h2 className="comparison-title">CFOs and owners rely on us to answer:</h2>
                ...
                <ul className="comparison-list muted">
                  <li>
                    ...
                    <span className="comparison-item-title">Can we safely distribute profits?</span>
                  </li>
                  ...
                  <li>
                    ...
                    <span className="comparison-item-title">Are margins improving or eroding?</span>
                  </li>
                  ...
                  <li>
                    ...
                    <span className="comparison-item-title">Is cash flow under control?</span>
                  </li>
              ...
              <div className="comparison-right-card">
                <h2 className="comparison-title">How we help you see clearly:</h2>
                ...
                <ul className="comparison-list emphasized">
                  <li>
                    ...
                    <span className="comparison-item-title">Proper expense classification</span>
                  </li>
                  ...
                  <li>
                    ...
                    <span className="comparison-item-title">Accurate revenue timing</span>
                  </li>
                  ...
                  <li>
                    ...
                    <span className="comparison-item-title">Clean balance sheets</span>
                  </li>
            ...
            <p className="comparison-footer-text">
              The result is straightforward: Reliable numbers that withstand scrutiny, support decisions, and reduce financial surprises.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="pricing" className="pricing-section pricing-section--auditing">
        <div className="pricing-section__container">
          <div className="pricing-section__auditing-header">
            ...
            <h2 className="pricing-section__auditing-title h1-montserrat">Accounting & Bookkeeping Pricing</h2>
          </div>

          <div className="pricing-section__grid pricing-section__grid--single">
            <div className="pricing-section__card">
              <h3 className="pricing-section__card-title h3-montserrat">Monthly Bookkeeping</h3>

              <div className="pricing-section__price">
                <span className="pricing-section__price-amount h1-montserrat">From AED 1,500</span>
                <span className="pricing-section__price-note body-opensans">+ VAT / month</span>
              </div>

              <p className="pricing-section__card-description body-opensans">
                Subject to transaction volume. Includes continuous record maintenance, monthly reporting, and audit-ready financials.
              </p>
              ...
              <ul className="pricing-section__features">
                {[
                  ...
                  'Expense classification & revenue timing',
                  'Clean balance sheet maintenance',
                ].map((feature, idx) => (
      ...
      <section className="service-consultation">
        <div className="service-consultation__container">
          <p className="service-consultation__text body-opensans">
            Discuss your transaction volume and requirements in a <strong>free 30-minute consultation</strong>.
          </p>
